...
final class FixedLengthInputStream extends AbstractHttpInputStream {
    ...
    public FixedLengthInputStream(InputStream is, CacheRequest cacheRequest,
        ...
        java.util.logging.Logger.getLogger("622").info("From FixedLengthInputStream.java: Inside constructor - calling super class (AbstractHttpInputStream) constr. w/o length. Length para/bytesRemaining \n");
